...
func registerArrayFilters() {
	...
	defaultRegistry.MustRegister("uniq", uniqueFilter)
	defaultRegistry.MustRegister("join", joinFilter)
	defaultRegistry.MustRegister("first", firstFilter)
	defaultRegistry.MustRegister("last", lastFilter)
	defaultRegistry.MustRegister("reverse", reverseFilter)
	defaultRegistry.MustRegister("size", sizeFilter)
	defaultRegistry.MustRegister("sort", sortFilter)
	defaultRegistry.MustRegister("sort_natural", sortNaturalFilter)
	defaultRegistry.MustRegister("compact", compactFilter)
	defaultRegistry.MustRegister("concat", concatFilter)
	defaultRegistry.MustRegister("where", whereFilter)
	defaultRegistry.MustRegister("reject", rejectFilter)
	defaultRegistry.MustRegister("find", findFilter)
	defaultRegistry.MustRegister("find_index", findIndexFilter)
	defaultRegistry.MustRegister("has", hasFilter)
	defaultRegistry.MustRegister("map", mapFilter)
	defaultRegistry.MustRegister("sum", sumFilter)

	// Extension filters (non-Liquid)
	defaultRegistry.MustRegister("random", randomFilter)
	defaultRegistry.MustRegister("shuffle", shuffleFilter)
	defaultRegistry.MustRegister("max", maxFilter)
	defaultRegistry.MustRegister("min", minFilter)
	defaultRegistry.MustRegister("average", averageFilter)

	// Aliases
	defaultRegistry.MustRegister("unique", uniqueFilter)
}
